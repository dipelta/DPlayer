        ...
        return function(e) {
            ...
            function(e, t, a) {
                ...
                e.exports = function(e) {
                    ...
                    i.live && (t += '\n        <span class="dplayer-custom-danmu">弹幕</span><span class="dplayer-live-badge"><span class="dplayer-live-dot" style="background: ', t += l(i.theme), t += ';"></span>', t += l(s("Live")), t += "</span>\n        "),
                                ...
                                var e = this,
                                    t = function(t) {
                                        var a = t || window.event,
                                            n = ((a.clientX || a.changedTouches[0].clientX) - r.getBoundingClientRectViewLeft(e.player.template.volumeBarWrap) - 5.5) / 60;
                                        e.player.volume(n)
                                    },
                                    a = function a() {
                                        document.removeEventListener(r.nameMap.dragEnd, a),
